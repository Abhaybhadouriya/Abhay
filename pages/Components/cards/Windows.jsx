...
const Windows = (props) => {
  ...
  React.useEffect(() => {
    const interval = setInterval(() => setValueTime(new Date()), 1000);
    ...
    <div style={sizewindow ? popup_box1 : popup_box2}>
      ...
      /> */}
              ...
              >
                ...
                >
                  <img
                    src="/img/windows/calculator.png"
                    style={{ width: "100%" }}
                  />
                  <div
                    style={{
                ...
                <div
                  onClick={() => {
                    props.handleClose("Windows"), props.openotherTab("Setting");
                  }}
                  style={{
                    margin: 10,
                    border: "1px solid rgb(189, 184, 184)",
                ...
                <div
                  onClick={() => {
                    props.handleClose("Windows"), props.openotherTab("Word");
                  }}
                  style={{
                    margin: 10,
                    border: "1px solid rgb(189, 184, 184)",
                ...
                <div
                  onClick={() => {
                    props.handleClose("Windows"), props.openotherTab("Chrome");
                  }}
                  style={{
                    margin: 10,
                    border: "1px solid rgb(189, 184, 184)",
                ...
                <div
                  onClick={() => {
                    props.handleClose("Windows"), props.openotherTab("About");
                  }}
                  style={{
                    margin: 10,
                    border: "1px solid rgb(189, 184, 184)",
