        ...
        >
          <div style={sizewindow ? style_box1 : style_box2}>
            ...
            {showChromeTab ? (
              <ChromeTab
                url={iframeUrl}
                backChromeTabfun={backChromeTabfun}
    ...
    <div className={styles1.carddiv}>
      <div className={styles1.card}>
        ...
        <div className={styles1.imgdiv}>
          ...
          <ul>
            ...
            <li>
              ...
              <b>
                {" "}
                NextJs, Vercel, Github, Python Flask, Firebase ,Youtube APIs
              </b>
            </li>
            <li>
              {" "}
          ...
          <button
            className={styles1.btbrowser}
            onClick={(e) => props.showChromeTabfun(e)}
            value="https://devtube.in"
          >
            Click to View
          </button>
        </div>
        <div className={styles1.imgdiv}>
          ...
          <ul>
            ...
            <li>
              {" "}
              Role :-{" "}
              <b>Web developer, Database Manager, Social Media Manager</b>
            </li>
          </ul>
          <button
            className={styles1.btbrowser}
            onClick={(e) => props.showChromeTabfun(e)}
            value="https://gurujikenotes.com/CosmaticServices/"
          >
            Click to View
          </button>
        </div>
        ...
        <div className={styles1.imgdiv}>
          ...
          <ul>
            <li>
              ...
              <b>
                ...
                It fetches data from covid19india.org
              </b>
            </li>
            <li>
          ...
          <button
            value="http://covidtracker.gurujikenotes.com/"
            onClick={(e) => props.showChromeTabfun(e)}
            className={styles1.btbrowser}
          >
            Click to View
