      ...
      >
        <div className={styles1.drivediv1}>
          ...
          <div className={styles1.drivedivinner} style={{ paddingLeft: 10 }}>
            ...
            <button className={styles1.bterror} onClick={closeModal}>
              close
            </button>
          </div>
        </div>
          ...
          <div className={styles1.diskdrivelist}>
            <div onClick={() => openModal()} className={styles1.drivediv}>
              ...
              <div className={styles1.drivedivinner}>
                <span style={{ fontSize: 18, marginBottom: 5 }}>
                  <b>Local Disk (C:)</b>
                </span>
            ...
            <div
              className={styles1.drivediv}
              onClick={() => documentdriveDOpenfuncion()}
            >
            ...
            <div
              className={styles1.drivediv}
              onClick={() => documentdriveEOpenfuncion()}
            >
              <img src="/img/Explorer/drive.png" style={{ width: 80 }} />
              <div className={styles1.drivedivinner}>
                <span style={{ fontSize: 18, marginBottom: 5 }}>
            ...
            <div onClick={() => openModal()} className={styles1.drivediv}>
              ...
              <div className={styles1.drivedivinner}>
                ...
                <span style={{ fontSize: 15, marginBottom: 5 }}>
                  0 bytes free of 79.6MB
                </span>
      ...
      <>
        ...
        <div className={styles1.diskdriveDdiv}>
          <div className={styles1.diskdriveDdivI}>
            ...
            <div className={styles1.diskdriveDdivIname}>
              <img
                className={styles1.diskViewerIcons}
              ...
              <a
                ...
                target="_blank"
                download="abhayresume.jpg"
              >
                <span style={{ fontSize: 25, marginLeft: 5 }}> Resume.pdf</span>
              </a>
            </div>
            <div className={styles1.diskdriveDdivIname}>
              <img
              ...
              <a
                rel="noreferrer"
                href="https://poetankita.in/wp-content/c4.jpg"
                target="_blank"
                download="python.jpg"
              >
                <span style={{ fontSize: 25, marginLeft: 5 }}> Python.jpg</span>
              </a>
            </div>
            <div className={styles1.diskdriveDdivIname}>
              <img
              ...
              <a
                rel="noreferrer"
                href="https://poetankita.in/wp-content/c3.jpg"
                target="_blank"
                download="android.jpg"
              >
            ...
            <div className={styles1.diskdriveDdivIname}>
              ...
              <a
                rel="noreferrer"
                href="https://poetankita.in/wp-content/c2.jpg"
                target="_blank"
                download="c++.jpg"
              >
                <span style={{ fontSize: 25, marginLeft: 5 }}> C++.jpg</span>
              </a>
            </div>
            <div className={styles1.diskdriveDdivIname}>
              <img
              ...
              <a
                rel="noreferrer"
                href="https://poetankita.in/wp-content/c1.jpg"
                target="_blank"
                download="kotlin.jpg"
              >
                <span style={{ fontSize: 25, marginLeft: 5 }}> Kotlin.jpg</span>
              </a>
            </div>
          </div>
          <div className={styles1.diskdriveDdivI}>
  ...
  const documentdrivesearchbar = (e) => {
    return (
      <div className={styles1.documentdrivesearchbar}>
        <img
          onClick={() => documentdriveClosefuncion()}
          src="/img/chromeimg/left-arrow.png"
          style={{ width: 35, marginLeft: 10, padding: 5 }}
        />
        <img
          src="/img/chromeimg/right-arrow.png"
          style={{ width: 35, marginLeft: 10, padding: 5, opacity: 0.2 }}
        />
        <input
          readOnly
          value={e}
        ...
        >
          <div style={sizewindow ? style_box1 : style_box2}>
            ...
            >
              <strong style={{ width: "100%", height: "100%" }}>
                <div className={styles.ChromeCard_Name_div}>
                  <img
                    src="/img/exploler.png"
                    width="25"
                    height="25"
                    alt="chrome"
                    id="img_taskbar"
                  />
                  <span style={{ fontWeight: 300 }}>&nbsp;&nbsp;Explorer</span>
                </div>
              </strong>
              <div className={styles.ChromeCard_bt_div}>
                <div
                  onClick={() => props.handleClose("Explorer")}
            ...
            {showmaindriveview
              ? iconexpolerer()
              : documentDfunction
              ? documentdriveDfuncion()
              : documentdriveEfuncion()}
          </div>
        </Resizable>
      </Draggable>
      {modelaction()}
